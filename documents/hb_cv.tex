...
%& \textbf{Quizzing:} \newline $\;\boldsymbol{\cdot}\;$Founder and Joint Co-ordinator of Dibrugarh University Debate and Quiz Forum \newline$\;\boldsymbol{\cdot}\;$Represented Dibrugarh University in 50+ quiz competitions at university level, district level and state level \newline
%\textbf{Sports:} Badminton \newline
%\textbf{Others:} Fine Arts and Graphic Design
%\end{SectionTable}
